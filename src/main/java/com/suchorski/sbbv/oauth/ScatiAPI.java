...
public class ScatiAPI {
	...
	public static final String CLIENT_PUBLIC = "SCATI_PUBLIC_CLIENT";
	public static final String CLIENT_SECRET = "SCATI_SECRET_CLIENT";
	public static final String SCOPE = "bve";
	
	public static final String URI_DOMAIN = "SCATI_URI";
	
	private static final String URI_OAUTH = String.format("http://%s/scati/oauth/v2/login", URI_DOMAIN);
	private static final String URI_LOGOFF = String.format("http://%s/scati/oauth/v2/logoff?token=%%s", URI_DOMAIN);
	private static final String URI_RESOURCE = String.format("http://%s/scati/resource/v2/userinfo/%%s/%%s", URI_DOMAIN);
	...
	public String generateLogonUri() {
		...
		return String.format("%s?response_type=%s&client_id=%s&redirect_uri=%s&scope=%s&state=%s", URI_OAUTH, responseType, publicKey, uriEncoded, "none", state);
	}
